                    ...
                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
                        <thead>
                            <tr style="background-color: #f7f7f7;">
                                <th style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd; font-size: 14px;">品名</th>
                                <th style="padding: 12px; text-align: center; border-bottom: 1px solid #ddd; font-size: 14px;">數量</th>
                                <th style="padding: 12px; text-align: right; border-bottom: 1px solid #ddd; font-size: 14px;">單價</th>
                            </tr>
                        </thead>
