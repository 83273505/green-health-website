...
[5.2] 不重複造輪子 (DRY)
AI 註記：
此版本為您提供的、已知可運作的穩定版本，是本次架構還原的核心。它取代了錯誤的 cartStore 架構。
更新日誌 (Changelog)：
v42.3：恢復至主席提供的、功能完整的單例模式購物車服務。
*/
...
if (error) throw error;
    ...
    if (!error.message.includes('aborted')) { // AbortError 已被 invokeWithTimeout 處理
