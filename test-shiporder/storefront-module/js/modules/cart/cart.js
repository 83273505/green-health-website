...
if (!state.isReadyForRender && state.isLoading) {
itemListElement.innerHTML = <p>正在同步您的購物車...</p>;
return;
}
...
const stockStatusLabel = isInsufficient ? '<span class="stock-status-label" style="color:red; font-weight:bold; margin-left:8px;">庫存不足</span>' : '';
