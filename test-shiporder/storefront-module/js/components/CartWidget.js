...
/**
檔案名稱：CartWidget.js
檔案職責：渲染頁面右上角的購物車圖示，並訂閱 CartService 以自動更新。
版本：39.1 (架構還原校準版)
SOP 條款對應：
[5.1] 嚴守邊界
AI 註記：
此版本已將所有對 cartStore 的依賴，完全修正為對 CartService 的依賴。
新增了在 init 時主動獲取一次初始狀態的邏輯，確保元件在載入時能立即反映正確的購物車數量。
更新日誌 (Changelog)：
v39.1：完成對 CartService 的依賴校準。
*/
...
container.innerHTML = <div id="cart-widget" style="position: relative; cursor: pointer; transition: opacity 0.3s;" title="查看購物車"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition: transform 0.5s;"> <circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle> <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path> </svg> <span id="cart-item-count" style="position: absolute; top: -8px; right: -8px; background-color: #D9534F; color: white; border-radius: 50%; padding: 2px 6px; font-size: 12px; font-weight: bold; display: none; line-height: 1;">0</span> </div>;
